...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'preventDefault': function() {
    /// <summary>If this method is called, the default activity of the event will not be triggered.</summary>
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'bind': function() {
    ...
    ///   <param name="eventType" type="String">A string containing one or more DOM event types, such as "click" or "submit," or custom event names.</param>
    ///   <param name="eventData" type="Object">An object containing data that will be passed to the event handler.</param>
    ///   <param name="preventBubble" type="Boolean">Setting the third argument to false will attach a function that prevents the default activity from occurring and stops the event from bubbling. The default is true.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an event for the elements.</summary>
